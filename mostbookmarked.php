                        ...
                        <div class="row">
                            <?php while ($row4 = $stmt4->fetch()) {
                                ...
                                if (($row5['publish_unpublish'])==1) {
                                    ...
                                    $articleTitle5 = $row5['article_title'];
                                    $date5 = date('d M Y', strtotime($row5['updated_date'])); ?>

                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="product__item" style="width: 230px;">
                                    <div class="product__item__pic set-bg" style="height: 350px" data-setbg="<?php echo $row5['article_photo']; ?>"></div>
                                    <div class="product__item__text" style="padding-top: 0px; text-align: center; height: 80px;">
                                    <?php echo "<h5><a href='anime-details.php?articleId=$articleId5&prevPg=$prevPg#target1'>$articleTitle5</a></h5>" ?>
                                    </div>
                                </div>
                            </div>
                        <?php } } ?>
