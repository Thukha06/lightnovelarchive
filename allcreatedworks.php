<?php
    ...
    $sql2 = "SELECT * FROM article_table ORDER BY article_title ASC";
    $stmt2 = $db->query($sql2);
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="product__item" style="width: 230px;">
                                    ...
                                    <?php echo "<h5><a href='anime-details.php?articleId=$articleId2&prevPg=$prevPg#target1'>$articleTitle2</a></h5>" ?>
                                    </div>
                                </div>
                            </div>
                        <?php } else { ?>
