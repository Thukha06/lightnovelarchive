<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO registration_table (website, gender, birthday, location, self_intro, occupation) VALUES ('$web', '$gender', '$date', '$location', '$intro', '$occupt')";
    $db->exec($sql);
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="index.php" class="h1"><b>Register</b>User</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg">Register first to start your session</p>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="row">
          ...
          <div class="form-group">
            <label>Occupation</label>
              <select name="occupt" class="form-control">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <textarea name="intro" class="form-control" rows="2" placeholder="Enter ..."></textarea>
          </div>
          </div>
        </div>
        <div class="row">        
