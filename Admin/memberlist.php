        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="memberlist.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable for Registered Member</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php foreach ($allusers as $row) {
                    ...
                    <tr>
                      ...
                      <?php 
                        ...
                        if (($row['user_type']) == ($row1['user_type'])) {
                      ?>
                      <td><?php echo $row1['user_type_name']; } } ?></td>
                      <td><?php echo $row2['joined_date']; ?></td>
                      <?php $status = $row['accept_reject']; if ($status == 1) { ?>
                      <td><?php echo "Active"; } else { echo "Inactive"; } ?></td>
                    </tr>
                  <?php } ?>
                  </tbody>
                </table>
