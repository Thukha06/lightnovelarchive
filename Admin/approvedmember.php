          ...
          <li class="nav-item ">
           ...
           <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="approvedmember.php" class="nav-link active
                ">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable for Approved Member</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php while ($row = $stmt->fetch()) { ?>
                    <tr>
                      <td><?php echo $row['aprov_user_name'] ?></td>
                      <td><?php echo $row['aprov_user_email'] ?></td>
                      <?php 
                        foreach ($users as $row1) {
                        if (($row['aprov_current_role']) == ($row1['user_type'])) {
                      ?>
                      <td><?php echo $row1['user_type_name']; } } ?></td>
                      <?php 
                        foreach ($users as $row2) {
                        if (($row['aprov_prev_role']) == ($row2['user_type'])) {
                      ?>
