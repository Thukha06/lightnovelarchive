<?php
  ...
  if (($_SERVER["REQUEST_METHOD"] == "GET") && (!empty($_GET['accept_articleId']))) {
    ...
    $sql3 = "UPDATE article_table SET publish_unpublish=1 WHERE article_id='$articleId'";
    $db->exec($sql3);
    echo "<script>location.href='requestarticle.php';</script>";
  }
...
<head>
  ...
  function ConfirmAccept(){
    var msg=confirm("Are you sure you want to Accept?");
    if(msg)
    return true;
    else return false;
  }
  ...
  function ConfirmReject(){
    var msg=confirm("Are you sure you want to Reject?");
    if(msg)
    return true;
    else return false;
  }
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="requestarticle.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable for Requested Article</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php while($row1 = $stmt1->fetch()) { 
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="row">
                        <div class="col-6">
                          <?php echo "<a class='button' href='requestarticle.php?accept_articleId=$articleId' onclick='return ConfirmAccept();'><button class='btn btn-block btn-success btn-sm'>Accept</button></a>" ?>
                        </div>
                        <div class="col-6">
                          <?php echo "<a class='button' href='requestarticle.php?reject_articleId=$articleId&chapId=$chapId' onclick='return ConfirmReject();'><button class='btn btn-block btn-danger btn-sm'>Reject</button></a>" ?>
                        </div>
                      </div>
                      </td>
                    </tr>
