<?php
    ...
    $sql1 = "SELECT * FROM article_table ORDER BY article_id DESC";
    $stmt1 = $db->query($sql1);
                    ...
                    <div class="header__nav">
                       <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="./illustrate.php">Novels List</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <div class="product__item" style="width: 230px;">
                                    ...
                                    <?php echo "<h5><a href='anime-details.php?articleId=$articleId1&prevPg=$prevPg#target1'>$articleTitle1</a></h5>" ?>
                                    </div>
                                </div>
                            </div>
                        <?php } else { ?>
